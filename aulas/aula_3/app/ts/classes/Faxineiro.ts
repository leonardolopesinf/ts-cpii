/*Vamos fazer com que faxineiro implemente a interface Funcionario, desta forma terá que seguir os requisitos
...
class Faxineiro extends Pessoa<string> implements Funcionario{
    ...
    /*Adicionaremos os requisitos necessarios para que Faxineiro seja um Funcionario.
    ...
    /*Criaremos uma variavel "_salario" que armazenará o salario inicial de um Faxineiro.
        Queremos que apenas a classe Faxineiro possa acessar esta variavel, então usaremos o "private".*/
    
    private _salario: number = 1000;

    /*Atenderemos a um dos padrões da interface Funcionário.
